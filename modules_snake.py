...
class snake():
    ...
    def agregarBody(self):
        ...
        self.Body.append(body(coord[0]-direction[0],coord[1]-direction[1],direction[0],direction[1]))
        print("YUMMY")
...
class food():
    ...
    def dibujarFood(self,display):
        pygame.draw.rect(display,RED,(self.coordx,self.coordy,self.height,self.width))
